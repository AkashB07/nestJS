...
export class UsersService {
  ...
  async create(userDto: CreateUserDto, userId: string) {
    ...
    // const result = await this.prisma.user.save(insertData);
  ...
  //     updated_by: userId,
  //   };
  //   await this.prisma.user.save(udpateUserData);
  //   return await this.findById(id);
  // }

  // async updatePassword(id: string, passwordHash: string) {
  //   return this.prisma.user.update(id, {
  ...
  //   return this.prisma.user.update(id, updateQuery);
  // }

  // async remove(id: string): Promise<void> {
  //   const deletedUser = await this.prisma.user.delete(id);
  ...
  //   const user = await this.prisma.user.save(userData);
